...
def extract_observed_outcomes(
    ...
    output_path="c:/Users/Ashish Tiwari/OneDrive/Desktop/Ignite/ml/data/processed/observed_outcomes.json"
):
    """
    Constructs canonical observed historical outcomes (Y), strictly preserving
    the distinction between observed zeros (0) and un-reported missing values (None/null).
    """
    ...
    for inc in incidents:
        ...
        outcomes.append({
            ...
            "data_quality_flags": {
                ...
                "damage_is_null": total_damage_usd is None,
    ...
    print(f"Successfully constructed {len(outcomes)} observed outcome records to {output_path}")
    return outcomes

if __name__ == "__main__":
    extract_observed_outcomes()
